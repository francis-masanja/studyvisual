...
const Settings = () => {
  ...
  const themes: { id: Theme; label: string; icon: React.ReactNode; color: string }[] = [
    ...
    { id: 'dark', label: 'Cozy Dark', icon: <Moon size={20} />, color: 'bg-[#121212]' },
    { id: 'blue', label: 'Cozy Blue', icon: <Cloud size={20} />, color: 'bg-[#f0f4f8]' },
    { id: 'red', label: 'Cozy Red', icon: <Heart size={20} />, color: 'bg-[#fdf2f2]' },
  ];

  return (
    <div className="min-h-screen bg-cozy-bg flex text-cozy-text pb-20 md:pb-0 relative z-0">
      {/* Desktop Sidebar */}
      ...
      <main className="flex-1 md:ml-64 p-4 md:p-8 overflow-y-auto">
        <header className="flex items-center gap-4 mb-8 pt-4 md:pt-0">
          <button 
            onClick={() => navigate('/dashboard')}
        ...
        <section className="bg-cozy-card rounded-3xl p-6 md:p-8 border border-cozy-secondary/10 shadow-sm max-w-2xl">
        ...
        <section className="mt-8 bg-cozy-card rounded-3xl p-6 md:p-8 border border-cozy-secondary/10 shadow-sm max-w-2xl">
